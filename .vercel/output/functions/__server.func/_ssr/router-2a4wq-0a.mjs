...
import { a as Sun, c as School, d as LayoutDashboard, f as GraduationCap, g as Award, h as ClipboardCheck, n as Users, o as Settings, p as GitBranch, t as X, u as Moon, y as PanelLeft } from "../_libs/lucide-react.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/router-2a4wq-0a.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
var styles_default = "/assets/styles-B_IuBwwh.css";
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SidebarHeader, {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						...
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(School, { className: "h-4 w-4" })
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(SidebarFooter, {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SidebarMenu, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SidebarMenuItem, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(SidebarMenuButton, {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Settings, { className: "h-4 w-4" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Configurações" })]
				}) }) }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "mt-2 flex items-center gap-2 rounded-md px-2 py-1.5 group-data-[collapsible=icon]:hidden",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						className: "flex h-7 w-7 items-center justify-center rounded-full bg-accent text-accent-foreground text-xs font-medium",
						children: "AD"
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "flex flex-col leading-tight",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
							className: "text-xs font-medium",
							children: "Ana Diretoria"
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
...
var STORAGE_KEY = "academica-theme";
...
function RootComponent() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(QueryClientProvider, {
		client: queryClient,
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ThemeProvider, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SidebarProvider, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(AppSidebar, {}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("header", {
					className: "sticky top-0 z-10 flex h-12 items-center gap-2 border-b border-border bg-background px-3",
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
							...
							children: "Sistema de Gestão Acadêmica"
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
...
var $$splitComponentImporter$5 = () => import("./turmas-B3hxGoW7.mjs");
var Route$5 = createFileRoute("/turmas")({
	head: () => ({ meta: [{ title: "Turmas — Acadêmica" }] }),
	component: lazyRouteComponent($$splitComponentImporter$5, "component")
});
var $$splitComponentImporter$4 = () => import("./notas-CyHf_9J7.mjs");
var Route$4 = createFileRoute("/notas")({
	head: () => ({ meta: [{ title: "Notas & Frequência — Acadêmica" }] }),
	component: lazyRouteComponent($$splitComponentImporter$4, "component")
});
var $$splitComponentImporter$3 = () => import("./funil-qKPOs_d-.mjs");
var Route$3 = createFileRoute("/funil")({
	head: () => ({ meta: [{ title: "Funil de Leads — Acadêmica" }] }),
	component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
var $$splitComponentImporter$2 = () => import("./certificados-CxV1D6E8.mjs");
var Route$2 = createFileRoute("/certificados")({
	head: () => ({ meta: [{ title: "Certificados — Acadêmica" }] }),
	component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
var $$splitComponentImporter$1 = () => import("./alunos-OzUhKnKM.mjs");
var Route$1 = createFileRoute("/alunos")({
	head: () => ({ meta: [{ title: "Alunos — Acadêmica" }] }),
	component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
var $$splitComponentImporter = () => import("./routes-D8MMmHqi.mjs");
var Route = createFileRoute("/")({
	head: () => ({ meta: [{ title: "Dashboard — Acadêmica" }, {
		name: "description",
		content: "Visão geral da operação acadêmica: alunos ativos, matrículas, evasão e funil."
	}] }),
	component: lazyRouteComponent($$splitComponentImporter, "component")
});
var TurmasRoute = Route$5.update({
	id: "/turmas",
	path: "/turmas",
	getParentRoute: () => Route$6
});
var NotasRoute = Route$4.update({
	id: "/notas",
	path: "/notas",
	getParentRoute: () => Route$6
});
var FunilRoute = Route$3.update({
	id: "/funil",
	path: "/funil",
	getParentRoute: () => Route$6
});
var CertificadosRoute = Route$2.update({
	id: "/certificados",
	path: "/certificados",
	getParentRoute: () => Route$6
});
var AlunosRoute = Route$1.update({
	id: "/alunos",
	path: "/alunos",
	getParentRoute: () => Route$6
});
